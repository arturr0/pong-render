...
function sleep(milliseconds) {
  ...
  function MoveBall(ball, pleft, pright)
  {
    ...
    if (ball.x - 10 < 20 && ball.y + 10 > pleft && ball.y - 10 < pleft + 60)
    {
      right = true;
      left = false;
    ...
    if (ball.x + 10 > 780 && ball.y + 10 > pright && ball.y - 10 < pright + 60)
    {
      right = false;
      left = true;
  ...
  io.sockets.on('connection',
    ...
    function (socket) {
      ...
      if (id_licz == 1) socket.broadcast.emit('start');
